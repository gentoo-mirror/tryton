...
pkg_postinst() {
	...
	ln -sf "${EROOT}"/usr/share/tempusdominus-bootstrap3-5 "${EROOT}"/usr/share/${PN}/bower_components/tempusdominus-bootstrap-3/build
...
pkg_prerm() {
	...
	rm -f "${EROOT}"/usr/share/${PN}/bower_components/tempusdominus-bootstrap3/build
