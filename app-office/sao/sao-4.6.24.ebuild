...
RDEPEND="${DEPEND}
	...
	dev-javascript/jquery:2
	dev-javascript/bootstrap:3
	dev-javascript/moment:2
	dev-javascript/bootstrap-datetimepicker:4
	dev-javascript/gettext:0
	dev-javascript/d3:3
	dev-javascript/c3:0
	dev-javascript/papaparse:4
	dev-javascript/fullcalendar:3
	dev-javascript/mousetrap:1"
