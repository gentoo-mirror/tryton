...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="graphviz +postgres sqlite levenshtein html2text weasyprint image barcode qrcode bash-completion email-validation test"
...
RDEPEND="acct-group/trytond
	...
	$(python_gen_cond_dep 'dev-python/backports-entry-points-selectable' python3_{8..9})
