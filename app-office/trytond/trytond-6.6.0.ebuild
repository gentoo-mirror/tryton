...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="doc graphviz mysql +postgres sqlite levenshtein bcrypt argon2 html2text weasyprint coroutine image bash-completion test"
...
RDEPEND="acct-group/trytond
	...
	$(python_gen_cond_dep 'dev-python/pytz[${PYTHON_USEDEP}]' python3_{7..9})
