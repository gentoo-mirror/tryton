...
RDEPEND="=app-office/trytond-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	=app-tryton/production_routing-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	=app-tryton/production_work-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	=app-tryton/timesheet-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]"
DEPEND="${RDEPEND}
