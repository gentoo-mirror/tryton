...
DESCRIPTION="Module to add a secondary unit on purchase line"
...
DEPEND="${RDEPEND}
	test? (
		...
		=app-tryton/purchase_amendment-$(ver_cut 1-2)*[${PYTHON_USEDEP}]
		=app-tryton/purchase_blanket_agreement-$(ver_cut 1-2)*[${PYTHON_USEDEP}]
