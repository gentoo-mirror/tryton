...
DESCRIPTION="Sale Promotion Module"
...
RDEPEND="=app-office/trytond-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	...
	=app-tryton/product_price_list-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	=app-tryton/sale-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
	=app-tryton/sale_price_list-$(get_version_component_range 1-2)*[${PYTHON_USEDEP}]
